    ...
    <div>
      ...
      <form action={formAction} className="max-w-md mx-auto flex gap-3">
        <input
          ...
          className="flex-1 bg-surface border border-border rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted focus:outline-none focus:border-black/10 transition-colors"
        />
        <button
          type="submit"
          disabled={pending}
